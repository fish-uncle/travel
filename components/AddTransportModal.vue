<template>
  <div v-if="show" class="modal-overlay" @click="closeModal">
    <div class="modal-content" @click.stop>
          ...
          <div v-else class="form-section">
            <div class="form-row">
              <div class="form-group">
                <label>交通方式</label>
                <VanField
                  v-model="formData.transportName"
                  type="text"
                  placeholder="如：出租车、地铁等"
                />
              </div>
              <div class="form-group">
                <label>时间</label>
            ...
            <div class="coordinates-section">
              <div class="coordinate-group">
                ...
                <div class="location-inputs">
                  <VanField
                    v-model.number="formData.fromLat"
                    type="number"
                    step="0.000001"
                    placeholder="纬度"
                  />
                  <VanField
                    v-model.number="formData.fromLng"
                    type="number"
                    step="0.000001"
                    placeholder="经度"
                  />
              ...
              <div class="coordinate-group">
                ...
                <div class="location-inputs">
                  <VanField
                    v-model.number="formData.toLat"
                    type="number"
                    step="0.000001"
                    placeholder="纬度"
                  />
                  <VanField
                    v-model.number="formData.toLng"
                    type="number"
                    step="0.000001"
                    placeholder="经度"
                  />
      ...
      <!-- 时间选择器 -->
      <VanPopup v-model:show="showTimePicker" position="bottom">
        <VanDatePicker
      ...
      <div class="modal-footer">
        <VanButton type="default" @click="closeModal"> 取消 </VanButton>
        <VanButton type="primary" @click="handleSubmit" :disabled="!canSubmit">
          添加
        </VanButton>
      </div>
    </div>
